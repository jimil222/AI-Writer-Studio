export default  [
    ...
    },
    {
        ...
        desc: 'An AI tool that crafts attention-grabbing subject lines to boost email open rates.',
        category: 'Marketing',
        icon: 'https://cdn-icons-png.flaticon.com/128/732/732200.png',
        aiPrompt: 'Generate 5 high-converting email subject lines based on the given email content and purpose. Keep them under 10 words for maximum impact.',
        ...
        form: [
            ...
            {
                label: 'Specify email goal (e.g., sales, engagement, newsletter)',
                field: 'input',
                name: 'goal'
            }
        ]
    },
    {
        ...
        desc: 'An AI tool that suggests engaging video ideas based on trending topics.',
        category: 'Content Creation',
        icon: 'https://cdn-icons-png.flaticon.com/128/4848/4848819.png',
        aiPrompt: 'Generate 5 viral YouTube video ideas based on the given niche and target audience.',
